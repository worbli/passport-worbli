...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://oauth.worbli.io';
  options.tokenURL = options.tokenURL || 'https://oauth.worbli.io/api/oauth/access_token';
  options.state = options.state || true;
  OAuth2Strategy.call(this, options, verify);

  this.name = 'worbli';
  this._userProfileURL = options.userProfileURL || 'https://portal-api.worbli.io/api/v3/user/me';
